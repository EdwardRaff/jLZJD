 ...
 * @author Edward Raff
 */
public class LZJD implements DistanceMetric, KernelTrick
{
...
//        System.out.println("   " + x_set.size() + " " + minFileLen + " " + minFileLen/Math.log(256));
...
//                x_minset = new int[Math.min(min_hash_size, hashes.size())];
    ...
    public static DataPoint getDPforFile(File f)
    {
        ...
        {
            Logger.getLogger(LZJD.class.getName()).log(Level.SEVERE, null, ex);
        }
